...
LEFT_PADDING="1"
RIGHT_PADDING="1"
NORMAL_BC="#2EC27E"		# Normal border color
FOCUSED_BC="#8FF0A4"	# Focused border color

# Terminal font & size
term_font_size="12"
term_font_name="CaskaydiaMono Nerd Font"
...
P_TERM_OPACITY="0.93"	# Terminal transparency. Range: 0.1 - 1.0 (1.0 = disabled)
...
CUSTOM_WALL="/home/kenny/.config/bspwm/rices/katsudouki/walls/wall-02.webp"
